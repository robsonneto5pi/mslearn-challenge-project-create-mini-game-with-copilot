...
# Emojis para escolhas e resultados
emoji_choices = {
    "rock": "🪨",
    "paper": "📄",
    "scissors": "✂️"
...
def get_user_choice():
    choice = input("Escolha rock 🪨, paper 📄 ou scissors ✂️: ").lower()
...
def play_game():
    ...
    while True:
        ...
        print(f"🤖 O computador escolheu: {emoji_choices[computer_choice]} {computer_choice}")

        result_key = determine_winner(user_choice, computer_choice)
        print(emoji_results[result_key])
    ...
    print("\n🏁 Pontuação final:")
    print(f"🕹️ Rodadas jogadas: {rounds}")
